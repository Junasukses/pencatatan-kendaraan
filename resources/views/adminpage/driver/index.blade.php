        ...
        <div class="col">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Driver Yang Ada</h6>
                </div>
                <!-- Card Body -->
                ...
                <div class="card-body table-responsive">
                    <table id="tabelBarang" class="table table-striped align-middle">
                        ...
                        <tr>
                            ...
                            <td><img src="images/{{$item->foto}}" alt="" class="img-fluid img-thumbnail" width="200px" height="200px"></td>
                            <td class="align-middle">{{$item->nama}}</td>
                            <td class="align-middle">
                                <a href="/driver/{{$item->id}}/edit" class="btn btn-warning">Edit</a>
                            </td>
                            <td class="align-middle">
                    ...
                    <a href="/driver/create" class="btn btn-primary">Tambah</a>
                </div>
            </div>    
    </div>        
    </div>    
